...
<div class="body" id="cde">
    <div class="texto">
        <div id="cargar" class="text-center">
            ...
            <span> En este panel podra generar los reportes obtenidos de cada proyecto,<br>
                mediante la descarga de archivos en formato xls.</span><br><br>
        </div>
    </div>
    <div class="linea"></div>
    <div class="Cajas">
                                                            ...
                                                            <cufon class="cufon cufon-canvas"><cufontext>01</cufontext></cufon></strong>
                                                                <div class="extra-wrap">
                                                                        <h3 class="color-3"><strong>
                                                                                <cufon class="cufon cufon-canvas"><canvas style="width: 93px; height: 31px; top: 1px; left: -2px;"></canvas><cufontext>Descargar</cufontext></cufon></strong>
                                                                                <cufon class="cufon cufon-canvas"><canvas style="width: 135px; height: 31px; top: 1px; left: -2px;"></canvas><cufontext>Reportes</cufontext></cufon></h3>
                                                                </div>
                                                </div>
                                                <div class="wrapper">
                                                        <a class="button img-indent-r" href="descargar.php">&gt;&gt;</a>
                                                        <div class="extra-wrap form-control" style="font-size:15px;">
								Descarga de reportes de proyectos.
                                                                </div>
                                                </div>
                                        </div>
                                </div>
